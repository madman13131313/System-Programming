...
/*
The AllocFrame is used to avoid searching the entire HeapMap during Garbage-Collection.
The first Bytes (owners) of the outermost Chunks are within the allocFrame.
 */
//#warning IMPLEMENT STH. HERE
